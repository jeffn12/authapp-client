      ...
      <div id="login-container" className="border-2 border-gray-400 rounded-lg max-w-sm p-8">
        ...
        <div id="login-form" className="my-6">
          <form className="m-0">
            ...
            <button className="bg-blue-600 text-white rounded-lg w-full h-8 mt-3">Login</button>
          </form>
        </div>
        ...
        <p className="text-center text-sm">Don't have an account yet? <a href="/" className="text-blue-600">Register</a></p>
      </div>
    </div>
  )
}
